<div class="md:flex mt-40 md:space-x-10 items-start">
    <div data-aos="fade-down" class="md:w-7/12 relative">
        ...
        <img class="relative z-50 floating" src="{{asset('images/recycling.jpg')}}" alt="">
    ...
    <div data-aos="fade-down" class="md:w-5/12 mt-20 md:mt-0 text-gray-500">
        <h1 class="text-2xl font-semibold text-darken lg:pr-40">Businesses lost <span
                class="text-green-500">£6.9 billion</span> in food waste</h1>
        <div class="flex items-center space-x-5 my-5">
            ...
            <p>According to the Waste and Resources Action Programme (WRAP) report, the cost of food waste to UK businesses in 2019 was approximately £6.9 billion.</p>
        </div>
        <div class="flex items-center space-x-5 my-5">
            <div class="flex-shrink bg-white shadow-lg rounded-full p-3 flex items-center justify-center">
            ...
            <p>This includes the cost of wasted food, as well as associated costs such as waste disposal and management.</p>
        </div>
        <div class="flex items-center space-x-5 my-5">
            <div class="flex-shrink bg-white shadow-lg rounded-full p-3 flex items-center justify-center">
            ...
            <p> As far as waste management is concerned, businesses may have to fork out for an extra collection or a bigger container in order to dispose of their food waste which can result in significant costs over time.</p>
        </div>
    </div>
</div>
