<div class="mt-24 flex flex-col-reverse md:flex-row items-start md:space-x-10">
    ...
    <div data-aos="zoom-in-right" class="md:w-12/12">

        <div class="flex items-center space-x-20 mb-5">
            <span class="border border-gray-300 w-14 absolute"></span>
            <h1 class="text-gray-400 tracking-widest text-sm">Terms &amp; Conditions</h1>
        </div>
        ...
        <p class="text-gray-500 my-5 lg:pr-36">
            ** THIS IS AN EXAMPLE TEMPLATE OF TERMS AND CONDITIONS **
        </p>
        ...
        <p class="text-gray-500 my-5 lg:pr-36">
            The term 'Dropt' or 'us' or 'we' refers to the owner of the website whose registered office is [address]. Our company registration number is 11111XXX. The term 'you' refers to the user or viewer of our website.
        </p>
